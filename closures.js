...
function counterFactory(value) {
  return {
    inc: function() {
      return value += 1 //return not needed for this particular question because values are just being altered.  HOWEVER,  if the numuber needed to be saved*(see comment below), a return would be needed to utilze said value;
    },
    dec: function() {
      return value -= 1;
    }
